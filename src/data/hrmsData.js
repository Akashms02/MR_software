...
export const EMPLOYEES = [
  { id: 'GH001', name: 'Rajesh Kumar',   initials: 'RK', dept: 'Medical Affairs',    designation: 'Sr. Medical Officer',      location: 'Mumbai',    salary: 95000,  status: 'Active',    gender: 'M', joined: '2021-03-15', email: 'rajesh.k@gmaxepayhr.in',   phone: '9820012345' },
  { id: 'GH002', name: 'Priya Sharma',   initials: 'PS', dept: 'Clinical Research',  designation: 'Clinical Research Assoc.', location: 'Pune',      salary: 72000,  status: 'Active',    gender: 'F', joined: '2022-07-01', email: 'priya.s@gmaxepayhr.in',    phone: '9011234567' },
  { id: 'GH003', name: 'Anita Singh',    initials: 'AS', dept: 'Regulatory',         designation: 'Regulatory Affairs Mgr.',  location: 'Delhi',     salary: 88000,  status: 'On Leave',  gender: 'F', joined: '2020-11-10', email: 'anita.s@gmaxepayhr.in',    phone: '9312345678' },
  { id: 'GH004', name: 'Mohammed Ali',   initials: 'MA', dept: 'Manufacturing',      designation: 'Production Manager',       location: 'Hyderabad', salary: 78000,  status: 'Active',    gender: 'M', joined: '2019-06-20', email: 'mohammed.a@gmaxepayhr.in', phone: '9440012345' },
  { id: 'GH005', name: 'Sneha Patel',    initials: 'SP', dept: 'QA/QC',             designation: 'QA Lead',                  location: 'Ahmedabad', salary: 82000,  status: 'Active',    gender: 'F', joined: '2021-09-05', email: 'sneha.p@gmaxepayhr.in',    phone: '9712345678' },
  { id: 'GH006', name: 'Rohit Verma',    initials: 'RV', dept: 'Sales & Marketing',  designation: 'Regional Sales Manager',   location: 'Bangalore', salary: 91000,  status: 'Active',    gender: 'M', joined: '2020-02-14', email: 'rohit.v@gmaxepayhr.in',    phone: '9845012345' },
  { id: 'GH007', name: 'Kavitha Nair',   initials: 'KN', dept: 'HR',                designation: 'HR Manager',               location: 'Chennai',   salary: 76000,  status: 'Active',    gender: 'F', joined: '2021-05-22', email: 'kavitha.n@gmaxepayhr.in',  phone: '9444012345' },
  { id: 'GH008', name: 'Arun Gupta',     initials: 'AG', dept: 'Finance',            designation: 'Finance Controller',       location: 'Mumbai',    salary: 112000, status: 'Active',    gender: 'M', joined: '2018-08-01', email: 'arun.g@gmaxepayhr.in',     phone: '9820198765' },
  { id: 'GH009', name: 'Deepak Sharma',  initials: 'DS', dept: 'IT',                designation: 'IT Lead',                  location: 'Pune',      salary: 85000,  status: 'Active',    gender: 'M', joined: '2022-01-10', email: 'deepak.s@gmaxepayhr.in',   phone: '9011987654' },
  { id: 'GH010', name: 'Pooja Mehta',    initials: 'PM', dept: 'Medical Affairs',    designation: 'Medical Officer',          location: 'Delhi',     salary: 68000,  status: 'Probation', gender: 'F', joined: '2024-02-01', email: 'pooja.m@gmaxepayhr.in',    phone: '9312987654' },
]
