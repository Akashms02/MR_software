        ...
        {activeReport === 'dcr-day' && hasData() && (
          <>
            ...
            {currentData.doctorsMet && currentData.doctorsMet.length > 0 && (
              <Card className="p-6">
                <h3 className="mb-4 text-[14.5px] font-extrabold text-gray-855">Visited Doctor Records</h3>
            ...
            {currentData.chemistsMet && currentData.chemistsMet.length > 0 && (
              <Card className="p-6">
                <h3 className="mb-4 text-[14.5px] font-extrabold text-gray-855">Visited Chemist Records</h3>
                <div className="flex flex-col gap-3">
                  {currentData.chemistsMet.map((chem, idx) => (
                    <div key={idx} className="flex items-center justify-between rounded-xl border-[1.5px] border-blue-200 bg-blue-50/20 p-4 shadow-[0_2px_8px_rgba(59,130,246,0.04)]">
                      <div>
                        ...
                        <div className="text-sm font-extrabold text-gray-805">{chem.name}</div>
