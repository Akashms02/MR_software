          ...
          {loading && (
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
                <RefreshCw className="animate-spin" size={30} color="#C8F04A" />
                <span style={{ fontSize: '13px', fontWeight: 700, color: '#1E2937' }}>Retrieving your log metrics...</span>
              </div>
            </div>
          )}
          ...
          {activeReport === 'visit-summary' && hasData() && (
            <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
                ...
                <Card style={{ padding: '20px', borderLeft: '5px solid #C8F04A' }}>
