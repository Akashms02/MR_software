...
export default function AdminFieldTracking() {
  ...
  const updateMapLayer = (rec) => {
    ...
    // Workday workday-in (Blue color: #3B82F6)
    if (rec.startLocation?.lat != null) {
      ...
      .bindPopup(`<strong>Workday workday-in</strong><br/>Time: ${rec.startTime}`)
    ...
    // Workday workday-out (Indigo color: #6366F1)
                      ...
                      <div key={v.id || idx} className="relative mb-6">
                        ...
                        >
                          ...
                          <div className={isCompleted ? "mb-3" : "mb-0"}>
                            <div className="flex justify-between text-[11px] text-gray-655 font-bold mb-1 items-center font-sans">
