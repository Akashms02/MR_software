...
export default function EmployeeDocument() {
  ...
  const empName = user?.fullName || user?.name || 'Employee';
  ...
  const handleDownload = () => {
    ...
    try {
      ...
      const filename = selectedDocType === 'payslip'
        ? `payslip_employee_${empName.replace(/\s+/g, '_').toLowerCase()}_${formattedMonth}.pdf`
        : `${selectedDocType}_letter_employee_${empName.replace(/\s+/g, '_').toLowerCase()}.pdf`;
