...
const MELeaveReviewPage = () => {
  ...
  return (
    <div className="animate-[fadeIn_0.4s_ease-out] p-[10px]">
      {/* Welcome Banner */}
      <div className="bg-gradient-to-br from-[#3730A3] to-[#6366F1] rounded-[20px] p-[30px] text-white mb-[28px] shadow-[0_10px_25px_rgba(99,102,241,0.15)] relative overflow-hidden">
