...
export default function MEPayslip() {
  ...
  const handleDownload = async () => {
    if (previewUrl) {
      ...
      link.download = `payslip_me_${selectedMonth}.pdf`;
    ...
    try {
      ...
      const opt = {
        margin: [0, 0, 0, 0],
        filename: `payslip_me_${empName.replace(/\s+/g, '_').toLowerCase()}_${formattedMonth}.pdf`,
