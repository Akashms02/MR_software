  ...
  return (
    <div className="animate-[fadeSlideIn_0.35s_ease-out] flex flex-col h-[calc(100vh-104px)] min-h-0 overflow-hidden p-1">
      ...
      <div className="flex justify-end mb-5 gap-3.5 shrink-0">
        <button
          onClick={() => navigate('/medical-executive/assign-doctor')}
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-[22px] py-2.5 rounded-xl border-none bg-[#1D4ED8] text-white font-extrabold text-[13.5px] cursor-pointer shadow-[0_4px_12px_rgba(29,78,216,0.25)] hover:bg-[#1e40af] transition-all duration-150 outline-none"
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative w-60">
              ...
              <input
                ...
                placeholder="Search..."
                className="w-full pl-8.5 pr-3 py-1.5 rounded-lg border border-[#E5E7EB] text-[12px] outline-none bg-[#F9FAFB] focus:bg-white focus:border-[#1D4ED8] transition-colors duration-150 font-sans"
              />
            </div>
            {/* Status Tabs */}
            ...
            <button
              ...
              className="p-1.5 rounded-lg border border-[#E5E7EB] bg-white text-[#6B7280] hover:text-[#111827] hover:border-[#1D4ED8] cursor-pointer transition-all duration-150 flex items-center justify-center shrink-0"
              title="Refresh"
            >
              <RefreshCw size={13} />
            </button>
        ...
        {loading ? (
          ...
          <>
            ...
            <Pagination
              ...
              isLoading={loading}
              activeBtnClass="bg-[#1D4ED8] text-white"
            />
          </>
        )}
      </div>
