      ...
      <div className="flex items-center gap-4 mb-5 flex-wrap shrink-0">
        ...
        <div className="flex items-center gap-2 ml-auto">
          <button
            ...
            className="p-2 rounded-xl border border-[#E5E7EB] bg-white text-[#6B7280] hover:text-[#111827] hover:border-[#1D4ED8] cursor-pointer transition-all duration-150 flex items-center gap-1.5 text-[12.5px] font-semibold"
            title="Refresh"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-xl border-none bg-[#1D4ED8] text-white font-bold text-[12.5px] cursor-pointer shadow-[0_4px_12px_rgba(29,78,216,0.25)] hover:bg-[#1e40af] transition-all duration-150 outline-none"
          >
