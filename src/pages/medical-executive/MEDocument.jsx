...
export default function MEDocument() {
  ...
  const handleDownload = () => {
    ...
    try {
      ...
      const filename = selectedDocType === 'payslip'
        ? `payslip_me_${empName.replace(/\s+/g, '_').toLowerCase()}_${formattedMonth}.pdf`
        : `${selectedDocType}_letter_me_${empName.replace(/\s+/g, '_').toLowerCase()}.pdf`;
