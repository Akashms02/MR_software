...
function MSEHeader({ onBellClick, unreadCount }) {
...
export default function MedicalSalesExecutiveLayout({ children }) {
  ...
  const handleNotificationClick = (notification) => {
    ...
    if (typeLower.includes('leave') || titleLower.includes('leave') || descLower.includes('leave')) {
      ...
      navigate('/medical-sales-executive/tourplan');
      ...
      navigate('/medical-sales-executive/requests');
    } else if (typeLower.includes('track') || titleLower.includes('track') || descLower.includes('track')) {
      navigate('/medical-sales-executive/fieldtracking');
    } else {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#F0F2F5] font-sans">
      ...
      <div className="ml-[220px] flex-1 flex flex-col h-screen overflow-hidden min-w-0">
        <MSEHeader onBellClick={handleBellClick} unreadCount={unreadCount} />
