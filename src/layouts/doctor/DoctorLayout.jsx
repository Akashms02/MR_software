...
export default function DoctorLayout({ children }) {
  ...
  const displayName = user?.fullName || user?.name || user?.email?.split('@')[0] || 'Doctor'
  const displayRole = 'Medical Doctor'
  ...
  const navItems = [
    ...
    { id: 'finance',      icon: FileText,        label: 'My Payslips',   path: '/doctor/finance' },
    { id: 'me',           icon: User,            label: 'Me',            path: '/doctor/me' },
    { id: 'watercooler',  icon: Coffee,          label: 'Water Cooler',  path: '/doctor/watercooler' },
