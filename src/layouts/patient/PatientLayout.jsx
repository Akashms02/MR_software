...
export default function PatientLayout({ children }) {
  ...
  const navItems = [
    ...
    { id: 'finance', icon: FileText, label: 'My Payslips', path: '/patient/finance' },
    { id: 'me', icon: User, label: 'Me', path: '/patient/me' },
    { id: 'watercooler', icon: Coffee, label: 'Water Cooler', path: '/patient/watercooler' },
    { id: 'settings', icon: Settings, label: 'Settings', path: '/patient/settings' },
  ]
  return (
