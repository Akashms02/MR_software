...
function MRHeader({ onBellClick, unreadCount }) {
...
export default function MRLayout({ children }) {
  ...
  const handleNotificationClick = (notification) => {
    ...
    } else if (typeLower.includes('attendance') || titleLower.includes('attendance') || descLower.includes('attendance')) {
      navigate('/mr/attendance');
    } else {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#F0F2F5] font-sans">
      ...
      <div className="ml-[220px] flex-1 flex flex-col h-screen overflow-hidden min-w-0">
        <MRHeader onBellClick={handleBellClick} unreadCount={unreadCount} />
